    ...
    return (
        <aside
            className={cn(
                ...
                "w-48 -translate-x-full md:translate-x-0",
        ...
        >
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            title={""}
                            className={cn(
                                "flex items-center gap-3.5 px-6 py-3 text-sm font-medium transition-all group",
                                isActive
            ...
            {/* Bottom Section */}
            <div className="p-4 border-t border-border/50 space-y-1 bg-slate-50/50">
                <Link
                    href="/app/settings"
                    className={cn(
                ...
                <button
                    ...
                    className="w-full flex items-center gap-3 px-6 py-3 text-sm font-medium text-red-500 hover:bg-red-50 transition-all group"
                >
